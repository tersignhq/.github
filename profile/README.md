...
- **Export mappings** — EU Art-226b minimal tier · EN 16931 full tier · HK IRO s.51C retention (a records duty that binds today) · SEC 17a-4 / FINRA 4511-oriented formats · `ActionRecordV1` carries EU AI Act Art-50 disclosure content · `compliance-fields` extension proposed upstream ([x402#2853](https://github.com/x402-foundation/x402/pull/2853))
